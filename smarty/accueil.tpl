...
<div class="container-fluid main accueil">
	...
	<div class="row row-contenu-first">
		...
		<div class="detail" id="dt_pourquoi">
			...
			Mutualisant connaissance de la faune sauvage picarde avec expérience juridique pour une meilleure prise en compte de l'environnement, c'est tout naturellement que nous agissons dans des cas de destructions directe pour  informer sur les marches à suivre à respecter. <a href="http://www.picardie-nature.org" alt="www.picardie-nature.org">www.picardie-nature.org</a></p>
	...
	<div class="row">
		...
		<div class="apercu">
			...
			<p>L'objectif est d'obtenir une <b>carte précise de la location des nids d'hirondelles en Picardie</b> ainsi que des <b>informations sur l'occupation</b> qu'en ont les oiseaux.
